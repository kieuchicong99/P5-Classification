...
class MiraClassifier:
    ...
    def trainAndTune(self, trainingData, trainingLabels, validationData, validationLabels, Cgrid):
        ...
        """
        max_acc, max_C, max_weights = max([self.get_accuracy_c_weight(
            c, trainingData, trainingLabels, validationData, validationLabels) for c in Cgrid])
    ...
    def get_accuracy_c_weight(self, c, trainingData, trainingLabels, validationData, validationLabels):
        ...
        for iteration in range(self.max_iterations):
            ...
            accuracy = self.get_accuracy(
                weights, validationData, validationLabels)
            if accuracy > max_acc:
                max_acc = accuracy
